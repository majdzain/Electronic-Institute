...
public class AudioRecordView {
    ...
    public FrameLayout layoutReply;
    public ImageView closeReply;
    public CardView messageReply;
    ...
    private TextView timeText, textViewSlide,cancelText;
    ...
    LinearLayout gridImages,layoutIconsReply;
    ImageView iconReply;
    TextView txtIconReply;
    ProgressBar loadingImages;
    ...
    public void initView(ViewGroup view) {
        ...
        view.removeAllViews();
        view.addView(LayoutInflater.from(view.getContext()).inflate(R.layout.record_vie, null));
v = view;
        ...
        cancelText = view.findViewById(R.id.txtCancel);
        loadingImages = view.findViewById(R.id.loadingImages);
gridImages = view.findViewById(R.id.commentNewImages);
        layoutReply = view.findViewById(R.id.layoutReply);
        layoutIconsReply = view.findViewById(R.id.layoutIconsReply);
        txtIconReply = view.findViewById(R.id.txtIconReply);
        iconReply = view.findViewById(R.id.replyIcon);
        closeReply = view.findViewById(R.id.replyClose);
        messageReply = view.findViewById(R.id.replyMessage);
        textReply = view.findViewById(R.id.replyText);
        nameReply = view.findViewById(R.id.replyName);
                ...
                if (layoutAttachment.getVisibility() == View.VISIBLE) {
                    ...
                    anim.addListener(new Animator.AnimatorListener() {
                        ...
                        public void onAnimationEnd(Animator animator) {
                            layoutAttachment.setVisibility(GONE);
                        }
...
showSend(false);
    ...
    public void showSend(boolean b) {
        if(b){
            if(!isImages) {
                ...
                if (showCameraIcon) {
                    if (imageViewCamera.getVisibility() != GONE) {
                        imageViewCamera.setVisibility(GONE);
            ...
            if(!isImages) {
                if (imageViewSend.getVisibility() != GONE) {
    ...
    private void translateX(float x) {
        ...
        if (Math.abs(x) < imageViewMic.getWidth() / 2) {
            ...
            if (layoutLock.getVisibility() != GONE) {
    ...
    private void stopRecording(RecordingBehaviour recordingBehaviour) {
        ...
        layoutSlideCancel.setTranslationX(0);
        layoutSlideCancel.setVisibility(GONE);
        layoutLock.setVisibility(GONE);
        layoutLock.setTranslationY(0);
        ...
        if (recordingBehaviour == RecordingBehaviour.LOCKED) {
            ...
            layoutEffect2.setVisibility(GONE);
            layoutEffect1.setVisibility(GONE);
            editTextMessage.setHint("اكتب رسالة");
