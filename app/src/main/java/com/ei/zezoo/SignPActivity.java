...
public class SignPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_p);
        androidx.appcompat.app.ActionBar actionbar = getSupportActionBar();
        TextView textview = new TextView(getApplicationContext());
        RelativeLayout.LayoutParams layoutparams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        textview.setLayoutParams(layoutparams);
        textview.setText("دورات البرمجة والتطوير");
        ...
        String study[] = {"Java","C++","c#","Android","Python","HTML","CSS","PHP","Java Script"};
        ArrayAdapter<CharSequence> spinnerCurrencyArrayAdapter = new ArrayAdapter<CharSequence>(SignPActivity.this, R.layout.spinner_item, study);
