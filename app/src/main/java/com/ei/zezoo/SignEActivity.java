...
public class SignEActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_e);
        androidx.appcompat.app.ActionBar actionbar = getSupportActionBar();
        TextView textview = new TextView(getApplicationContext());
        RelativeLayout.LayoutParams layoutparams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        textview.setLayoutParams(layoutparams);
        textview.setText("دورات الللغة الإنكليزية");
        ...
        String study[] = {"المستوى 1","المستوى 2","المستوى 3","المستوى 4","المستوى 5","المستوى 6","المستوى 7","المستوى 8","المستوى 9","المستوى 10","المستوى 11","المستوى 12","المستوى 13","المستوى 14","المستوى 15"};
        ArrayAdapter<CharSequence> spinnerCurrencyArrayAdapter = new ArrayAdapter<CharSequence>(SignEActivity.this, R.layout.spinner_item, study);
